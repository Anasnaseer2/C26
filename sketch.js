...
for (var i=0; i<playerArrows.length; i++){
  var pcollision=Matter.SAT.collides(playerArrows[i].body,computerBase.body)
  var collision2=Matter.SAT.collides(playerArrows[i].body,computerArcher.body)
  var collision3=Matter.SAT.collides(playerArrows[i].body,computer.body)
  if(pcollision.collided|| collision2.collided|| collision3.collided){
...
function handleComputerArrowCollision() {
  ...
  for (var i=0; i<computerArrows.length; i++){
    var pcollision=Matter.SAT.collides(computerArrows[i].body,playerBase.body)
    var collision2=Matter.SAT.collides(computerArrows[i].body,playerArcher.body)
    var collision3=Matter.SAT.collides(computerArrows[i].body,player.body)
    if(pcollision.collided || collision2.collided || collision3.collided){
